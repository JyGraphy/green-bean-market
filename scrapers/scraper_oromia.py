"""오로미아코리아 생두 스크래퍼 — aram_shop /shop/list.php?ca_id=10"""
import re, time, sys
...
STORE = '오로미아코리아'
BASE  = 'https://www.oromia.kr'
URL   = BASE + '/shop/list.php?ca_id=10&page={page}'

def parse(html):
    soup = BeautifulSoup(html, 'html.parser')
    items = []
    for a in soup.select('a[href*="/shop/item"]'):
