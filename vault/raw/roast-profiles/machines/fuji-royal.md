...
- heat_source: 드럼(전도) — 반직화식(semi-direct fire) 가스 드럼
- temp_probe: 내장 프로브 없음 (국내는 후장착 서모커플+Artisan 조합)
- typical_total_time: 10–15분 (드럼을 약 200℃로 예열 후 150℃ 부근으로 낮춰 투입)
- chart_app: Artisan (자체 차트 앱 없음 — 후장착 프로브+Artisan 조합이 일반적)
- verified: no
...
- [Coffee roaster R-101 - fuji-royal.jp](https://fuji-royal.jp/en/products/roaster/r101/)
- [Coffee roaster R-105 - fuji-royal.jp](https://fuji-royal.jp/en/products/roaster/r105/)
- [Coffee Roaster FujiRoyal R101 - coffeesakura](https://www.coffeesakura.co.jp/eng/fujiroyalcoffeeroaster.html)
- [Fuji ROYAL - 후지로얄 R-101-K (한국 공식 대리점)](http://www.fujiroyal.kr/m/product/1)
- 검증 대기 — 실제 Fuji Royal/Artisan 차트 이미지로 아직 테스트하지 못함
- 참고: 배치 용량·예열 온도 이외의 온도 프로브 구성·자체 소프트웨어 유무는 검색으로 확정하지 못해 "미확인"으로 남김
